...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        setForm({ ...form, photo: `data:image/jpge;base64,${data.photo}` })
      } catch (error) {
        console.log(error);
      } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      alert('please enter prompt and click generate then share with community');
    }
  }
  ...
  return (
    <section>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Create imaginative and visually stunning images generated by DALL-E AI and Share with the community</p>
      </div>
